...
from server.helper import nms, adjust_input, generate_bbox, detect_first_stage_warpper
    ...
    def detect_face(self, img, det_type=0):
        ...
        if det_type==0:
            ...
            if len(total_boxes) == 0:
                # print("if len(total_boxes) == 0:")
                return None
            
            total_boxes = np.vstack(total_boxes)

            if total_boxes.size == 0:
                # print(" if total_boxes.size == 0:1")
                return None
        ...
        if total_boxes.size == 0:
            print(np.where(output[2][:, 1]))
            # print("if total_boxes.size == 0:3")
            return None
